...
You are assigned a topic. Drive an AI assistant through a literature review on it: ask for the state of the field, the canonical papers, the open questions. Then verify everything.
...
| 2 | Annotated defects-and-strengths list, both papers | 20 | 10 (analyze failure modes), 12 (appraise claim–evidence for an audience) |
| 3 | Quality rubric with genre declaration | 25 | 11 (own your standards), 12 (genre- and audience-specific criteria) |
| 4 | Agent spec + eval report (spec, eval set, scorer, kappa, failure analysis) | 40 | 10 (full eval machinery), 11 (defend the agent's verdicts as your own) |
