...
* Use **Pull requests** to allow others to suggest code changes to a repos. The pull request tracks line-by-line changes and allow the repository contributors. The new developer can work on an independent fork of the repository, then suggest the changes using the pull request.
...
```{figure} overview-github-collavoearion.png
:width: 300px
---
