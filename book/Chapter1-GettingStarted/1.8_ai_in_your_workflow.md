...
```{admonition} 🔒 By hand
:class: attention
Assistant closed — do this unaided; it builds a skill you must own ([1.8](1.8_ai_in_your_workflow.md)).
```

```{admonition} 🤝 Assistant allowed
:class: tip
Use your assistant if you want — verify every line and disclose the use in your submission ([1.8](1.8_ai_in_your_workflow.md)).
```
