...
| 7 | Exploiter la connaissance physique comme ressource : générer des données synthétiques d'entraînement et de test à partir de modèles physiques, inscrire des contraintes physiques dans les fonctions de perte et les architectures, et valider contre une vérité terrain connue | Créer / Évaluer | 2.10, 4.7, `mlgeo_synth` | TP 4.5, exercice 6.3 (jeu d'évaluation) |
