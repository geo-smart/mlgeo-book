...
Ce cours propose plusieurs parcours pour les étudiants en géosciences. Les jeux de données peuvent être téléchargés et utilisés dans les divers exercices (classification, régression, partitionnement (*clustering*)…).
