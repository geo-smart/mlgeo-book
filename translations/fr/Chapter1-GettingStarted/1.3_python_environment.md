...
- **uv** — un gestionnaire rapide pour les projets purement Python (paquets PyPI seulement). Un bon choix quand vous n'avez besoin d'aucune pile géospatiale ou GPU compilée issue de conda-forge.
- **miniforge / mamba** — une distribution conda minimale préconfigurée pour le canal communautaire conda-forge, avec `mamba` comme solveur rapide. À choisir si vous voulez les flux de travail conda classiques.
