...
4. **Réseaux de neurones convolutifs** (4.3)
   ...
   - Un CNN 2-D qui régresse des tendances de réchauffement sur un champ climatique synthétique, lu face à des modèles de référence (*baselines*) par moindres carrés
...
7. **Auto-encodeurs et auto-supervision** (4.6)
   ...
   - Une sonde de transfert miniPNW : les caractéristiques traversent l'écart synthétique-réel, les frontières de décision non
...
8. **Apprentissage informé par la physique** (4.7)
   ...
   - Un modèle de référence en différences finies qui bat le PINN sur le problème direct (~750 fois plus rapide, 100 fois plus précise)
...
L'apprentissage par transfert apparaît là où il sert : le carnet 4.6 se clôt sur une sonde linéaire (*linear probe*) posée sur un encodeur pré-entraîné gelé, ce qui est de l'apprentissage par transfert en miniature. Les grands modèles de langage et les agents IA sont traités au chapitre 6.
...
- Choisir des modèles de prévision et les comparer à des modèles de référence, avec des découpages temporels sans fuite de données.
