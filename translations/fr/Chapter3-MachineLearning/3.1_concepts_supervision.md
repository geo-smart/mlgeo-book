...
| **Actif**  | Entraînement continu du modèle pour améliorer la performance | Majoritairement non étiquetées, quelques données étiquetées | Performance mesurée sur des ensembles de validation étiquetés, en s'attachant à l'efficacité du processus d'étiquetage. |
