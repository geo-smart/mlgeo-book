...
- **Les ensembles de test cachés existent.** L'enseignant détient des variantes régénérées des jeux de données du cours, avec des graines aléatoires privées. Des scores réglés sur un ensemble de test public feront apparaître un écart sur l'ensemble caché.
