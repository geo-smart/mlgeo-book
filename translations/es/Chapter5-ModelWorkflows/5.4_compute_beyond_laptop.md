...
- **México**: el [LANCAD](https://www.lancad.mx/) (Laboratorio Nacional de Cómputo de Alto Desempeño, consorcio de la UNAM, la UAM y el Cinvestav) publica convocatorias periódicas de asignación de horas de cómputo; los proyectos se presentan con una persona responsable adscrita a una institución participante.
...
- **Chile**: el [NLHPC](https://www.nlhpc.cl/) (Laboratorio Nacional de Computación de Alto Rendimiento, con sede en la Universidad de Chile) da cuentas de cómputo a personal académico y estudiantado de posgrado de instituciones chilenas.
