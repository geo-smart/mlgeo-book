...
El RL sigue siendo raro en las geociencias porque pocos problemas ofrecen un entorno seguro para millones de interacciones de ensayo y error. Existen ejemplos operativos en el muestreo adaptativo, donde vehículos autónomos submarinos o aéreos aprenden trayectorias de relevamiento que maximizan la ganancia de información, y en la gestión de embalses y de aguas subterráneas — el tipo de problema de asignación que enfrenta una agencia como la CONAGUA —, donde los calendarios de inyección y bombeo se optimizan contra simuladores. El RL es también el mecanismo detrás del posentrenamiento de los modelos de lenguaje de gran escala a partir de retroalimentación humana.
