...
3. **¿Qué podría salir mal si se equivoca — y quién paga ese costo?** Los errores del modelo tienen dirección: las falsas alarmas y las pérdidas caen sobre personas distintas. Nombre ambas direcciones de falla y quién paga cada una. Señale cuándo quienes cargan con el costo no son quienes eligieron desplegar el modelo.
...
*El proyecto:* una LSTM que predice el nivel del río con 24 h de anticipación para dos cuencas aforadas del bajo Grijalva, en Tabasco, superando a la persistencia en 30 % de RMSE durante los nortes de la temporada de lluvias.
