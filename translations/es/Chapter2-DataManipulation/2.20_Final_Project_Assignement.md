...
4. **Organización de los datos en un formato listo para la IA**
   ...
   - **Requisitos**:
     ...
     - Incluya un cuaderno (`notebooks/Prepare_AI_Ready_Data.ipynb`) que describa con claridad:
       - La forma final de los datos (número de muestras, atributos y etiquetas objetivo).
       - Una descripción de cada atributo por muestra de datos, cuál es su significado físico, y escriba la dimensionalidad original de los datos con base en el número de atributos.
...
5. **Análisis exploratorio de datos (EDA)**
   ...
   - **Requisitos**:
     - Cree un cuaderno (`notebooks/EDA.ipynb`) que incluya:
       ...
       - Visualización de las distribuciones de los atributos (histogramas, diagramas de caja, etc.).
       - Análisis de correlación entre los distintos atributos y las variables objetivo (matriz de correlación, mapas de calor).
   ...
   - **Requisitos**:
     - En un cuaderno (`notebooks/Dimensionality_Reduction.ipynb`):
       ...
       - Proponga e implemente al menos dos técnicas de reducción de dimensionalidad:
         - Técnicas de extracción de atributos como el PCA (análisis de componentes principales).
